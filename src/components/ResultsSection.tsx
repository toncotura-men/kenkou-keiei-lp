...
function MetricCard({
  ...
  return (
    ...
    >
      ...
      <div className="text-emerald-100 font-semibold text-lg mb-1">{label}</div>
      <div className="text-emerald-200 text-xs">{sub}</div>
    </motion.div>
  );
}
...
export default function ResultsSection() {
  return (
    <section id="results" className="py-24 bg-emerald-600 relative overflow-hidden">
        ...
        >
          <div className="text-center lg:text-left">
            ...
            <p className="text-emerald-100 text-sm">
              現在の健康経営の課題を30分でヒアリングし、最適な改善策をご提案します
            </p>
          </div>
          <a
            href="#contact"
